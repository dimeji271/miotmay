        ...
        <div class="row">
            <div class="col">
                <div class="login-area">
                    <div class="login-box">
                        <h1>Registration</h1>
                        <p color="success">Kindly fill in all required information</p>
                        ...
                        <form class="" action="" method="post" enctype="multipart/form-data">
                            ...
                            <input type="submit" name="register" class="btn-style1" value="Register">
                    ...
                    <div class="login-account">
                        ...
                        <a href="login.php" class="ceate-a">Login</a>
